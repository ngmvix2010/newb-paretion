...
#define NL_GAMMA 1.45                  // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 1.72              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 0.94            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
/* Lighting */
#define NL_SUNLIGHT_INTENSITY   4.1  // 1.0 weak ~ 5.0 bright
#define NL_TORCHLIGHT_INTENSITY 2.0  // 0.5 weak ~ 3.0 bright
#define NL_SHADOW_INTENSITY     1.0  // 0.0 no shadow ~ 1.0 strong shadow
#define NL_MIN_LIGHTING_BOOST   1.25  // 1.0 minimal lighting boost for dark areas ~ 3.0 brighter dark areas
...
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.56,0.1)
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,0.78,0.67)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.01,0.03,0.35)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.3,0.762,0.18)
#define NL_UNDERWATER_TORCH_COL vec3(1.3,0.762,0.18)
#define NL_NETHER_TORCH_COL     vec3(1.3,0.762,0.18)
#define NL_END_TORCH_COL        vec3(1.3,0.762,0.18)
...
#define NL_DAWN_ZENITH_COL   vec3(0.3,0.26,0.45)
#define NL_DAWN_HORIZON_COL  vec3(3.0,0.6,0.4)
#define NL_DAWN_EDGE_COL     vec3(2.0,1.1,0.8)
#define NL_DAY_ZENITH_COL    vec3(0.1,0.3,0.55)
#define NL_DAY_HORIZON_COL   vec3(0.6,0.65,0.75)
#define NL_DAY_EDGE_COL      vec3(1.44,1.56,1.62)
#define NL_NIGHT_ZENITH_COL  vec3(0.008,0.048,0.098)
#define NL_NIGHT_HORIZON_COL vec3(0.02,0.06,0.25)
#define NL_NIGHT_EDGE_COL    vec3(0.04,0.08,0.1)
#define NL_RAIN_ZENITH_COL   vec3(0.37,0.41,0.46)
#define NL_RAIN_HORIZON_COL  vec3(0.54,0.54,0.54)

#define NL_END_ZENITH_COL    vec3(0.097,0.001,0.13)
#define NL_END_HORIZON_COL   vec3(0.6,0.02,0.667)
...
/* Ore glow intensity */
#define NL_GLOW_TEX 6.73           // 0.4 weak ~ 8.0 bright
#define NL_GLOW_SHIMMER 0.8       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 0.9 // 0.5 slow - 2.0 fast
#define NL_GLOW_LEAK 0.21        // [toggle] 0.08 subtle ~ 1.0 100% brightness of NL_GLOW_TEX

/* Waving */
#define NL_PLANTS_WAVE 0.22    // [toggle] 0.02 gentle ~ 0.4 violent
#define NL_LANTERN_WAVE 0.16   // [toggle] 0.05 subtle ~ 0.4 large swing
#define NL_WAVE_SPEED 1.62      // 0.5 slow wave ~ 5.0 very fast wave
...
#define NL_CLOUD3_SCALE vec2(0.021, 0.03) // 0.003 large ~ 1.0 tiny
#define NL_CLOUD3_SPEED 0.005            // 0.0 static ~ 4.0 fast moving
#define NL_CLOUD3_SHADOW 0.9             // 0.1 subtle ~ 1.0 dark
#define NL_CLOUD3_SHADOW_OFFSET 0.34      // 0.05 minimal ~ 1.0 large
...
#define NL_GROUND_RAIN_PUDDLES 2.0 // 0.0 no puddles ~ 1.0 puddles

/* Entity (Actor, ItemInHand) */
#define NL_ENTITY_BRIGHTNESS     0.45 // 0.1 dark ~ 1.6 bright
#define NL_ENTITY_EDGE_HIGHLIGHT 0.01 // [toggle] 0.0 no highlight ~ 1.6 bright highlight

/* Weather particles */
#define NL_WEATHER_SPECK 1.0         // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 3.0    // 1.0 minimal ~ 8.0 violent
...
/*
Newb Paretion Settings Zone
Developer: ngmvix2010_
*/

/* Cirrus cloud settings */
#define NP_CIRRUS_CLOUD
#define NP_CIRRUS_CLOUD_SPEED 0.06
#define NP_CIRRUS_CLOUD_SCALE 1.2
#define NP_DISABLE_NEWB_CLOUD

/* LowPoly Chunk settings */
//#define NP_LOWPOLY_CHUNK 2.0
#define NP_LOWPOLY_CHUNK_MIN_DISTANCE 64.0

/* Volumetric cloud settings */
//#define NP_VOLUME_CLOUD 2
#define NP_VOLUME_CLOUD_SPEED 0.03
#define NP_VOLUME_CLOUD_DENSITY1 0.7
#define NP_VOLUME_CLOUD_DENSITY2 0.55
#define NP_VORO_ENABLED 0 // 0: false, 1: true
#define NP_VOLUME_CLOUD_SHADOW 0.6
...
*/
  ...
  #undef NP_CIRRUS_CLOUD
  #undef NL_CHUNK_LOAD_ANIM
  #define NP_LOWPOLY_CHUNK 2.0
  #undef NL_GROUND_RAIN_WETNESS
  #define NL_GROUND_RAIN_WETNESS 0.0
#endif
